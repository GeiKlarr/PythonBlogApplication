...
class ProfilePageForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'user': forms.TextInput(attrs={'class':'form-control', 'value': '', 'id': 'poster','placeholder':''}),   
            }
...
class ProfileChangingForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = {'profile_pic'}
...
class ProfileAddFrom(forms.ModelForm):
    class Meta:
        model = Profile
        fields = {'profile_pic','user'}
